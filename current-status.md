...
### ⚡ **v2.0 다음 단계 계획 (사용자 심리 기반 재정렬)** 🎯
- [ ] **📋 랭킹 탭 시스템** (일간/주간/월간/전체 탭) - 45분 예상 ← **다음 할 일**
- [ ] **📢 실시간 피드 알림** ("XX님이 30분 달성!") - 60분 예상
- [ ] **💬 종료 플로우 개선** (랭킹 등록 모달 + 아이디 입력) - 45분 예상
- [ ] **📝 더 많은 비난 멘트 확장** (50개 + 랭킹 기반 특별 멘트)
